...
const Discover = () => {
  ...
  useEffect(() => {
    ...
    const fetchArtistsData = async () => {
      const similarArtists = await fetchSearchResults(searchInput.name, 'artist');
  ...
  return (
    <section className="main main_closed">
        <div>
            <SearchBar placeholder="Enter a song/artist" searchInput={searchInput} setSearchInput={updateSearchInput}/>
